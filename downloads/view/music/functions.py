...
ALL_GENRES = ['genreid:MA0000012170', 'genreid:MA0000002467', 'genreid:MA0000002944', 'genreid:MA0000002521',
              'genreid:MA0000004433', 'genreid:MA0000002532', 'genreid:MA0000002567', 'genreid:MA0000002572',
              'genreid:MA0000002592', 'genreid:MA0000012075', 'genreid:MA0000002660', 'genreid:MA0000002674',
              'genreid:MA0000002692', 'genreid:MA0000002745', 'genreid:MA0000002613', 'genreid:MA0000002809',
              'genreid:MA0000002816', 'genreid:MA0000002820', 'genreid:MA0000004431', 'genreid:MA0000004432',
              'genreid:MA0000011877']
...
def get_album_music_titles(url):
    ...
    names_list = [songs_section.find('div', class_="title").find('a').text for songs_section in songs_sections]
    return names_list


def get_all_music_titles(genre, page_number: str = "2"):
    url = "https://www.allmusic.com/advanced-search/results/" + page_number
